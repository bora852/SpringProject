				...
				<div class="container">
					...
					<%} %>
						...
						<div class = "input_info">
							<span>아이디</span>
							<input type="text" name="id" style="width:300px; height:30px;font-size:15px;" placeholder="아이디를 입력해주세요." value="${prev.id }">
						</div>
						<div class = "input_info">
							<span>비밀번호</span>
						...
						<div class = "input_info">
							<span>주소</span>
							<input type="text" name="addr" style="width:300px; height:30px;font-size:15px;" placeholder="address" value="${prev.addr }">
						</div>
						<div class = "input_info">
							<span>전화번호</span>
							<input type="tel" name="tel" style="width:300px; height:30px;font-size:15px;" placeholder="010-xxxx-xxxx" value="${prev.tel }">
						</div>
						<div class = "input_info">
							<span>알레르기</span>
